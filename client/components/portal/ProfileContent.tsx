...
import { User, Mail, Phone, Save, Loader2, Edit, X } from 'lucide-react';
...
export function ProfileContent() {
  const { customer, isLoading: isSessionLoading, update: updateSession } = useCustomerSession();
      ...
      <div className="flex justify-between items-center mb-8">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            ...
            <motion.div variants={itemVariants}>
             ...
             <motion.div variants={itemVariants}>
                <label className="text-sm font-medium">{t('dashboard:profile.email')}</label>
                <div className="relative mt-1">
                    <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
