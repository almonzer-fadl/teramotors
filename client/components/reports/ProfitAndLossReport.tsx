...
export const ProfitAndLossReport = ({ data }: { data: any }) => {
    ...
    const revenueBreakdownData = [
        { name: 'Service Revenue', value: serviceRevenue },
        { name: 'Parts Revenue', value: partsRevenue },
    ];
        ...
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <StatCard 
                    ...
                    tooltip="Sum of all invoice totals (services + parts)."
                />
                <StatCard 
                    ...
                    tooltip="Total cost of parts used in completed jobs."
                />
                <StatCard 
                    title="Gross Profit" 
                    ...
                    tooltip="Total Revenue minus Cost of Goods Sold."
                />
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div className="bg-white/80 dark:bg-gray-900/80 backdrop-blur-sm p-6 rounded-3xl shadow-lg shadow-gray-200/50 dark:shadow-black/30 border border-gray-100 dark:border-gray-800">
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="flex justify-between items-center py-3 border-b border-gray-200 dark:border-gray-700">
                            <span className="text-gray-600 dark:text-gray-400">Parts Revenue</span>
                        ...
                        <div className="flex justify-between items-center pt-4">
                            <span className="font-semibold text-gray-900 dark:text-white text-lg">Gross Profit</span>
                            <span className="font-bold text-xl text-blue-600 dark:text-blue-400">{formatCurrency(grossProfit)}</span>
                        </div>
                         <div className="flex justify-between items-center pt-4">
                            <span className="text-gray-600 dark:text-gray-400">Gross Profit Margin</span>
            ...
            <div className="bg-white/80 dark:bg-gray-900/80 backdrop-blur-sm p-6 rounded-3xl shadow-lg shadow-gray-200/50 dark:shadow-black/30 border border-gray-100 dark:border-gray-800">
                ...
                <div className="text-sm text-gray-600 dark:text-gray-400 space-y-3">
                    <p>
                        <strong className="text-gray-800 dark:text-gray-200">Total Revenue:</strong> This is the total amount of money invoiced to customers for both services and parts within the selected date range. It represents the total income before any expenses are deducted.
                    </p>
                    <p>
                        <strong className="text-gray-800 dark:text-gray-200">Cost of Goods Sold (COGS):</strong> This figure represents the direct cost of the parts sold to customers to perform repairs. It is the sum of the 'cost' price of all parts listed on the job cards associated with the invoices in this period.
                    </p>
                    <p>
                        <strong className="text-gray-800 dark:text-gray-200">Gross Profit:</strong> This is the profit made directly from selling services and parts. It is calculated by subtracting the COGS from the Total Revenue. This number does not account for operational expenses like rent, salaries, or utilities.
                    </p>
                </div>
            </div>
        </div>
