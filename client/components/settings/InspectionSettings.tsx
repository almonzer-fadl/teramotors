...
export default function InspectionSettings() {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      if (response.ok) {
        setMessage({ type: 'success', text: 'Inspection settings saved successfully!' });
      } else {
    ...
    >
      ...
      <div className="bg-white/95 dark:bg-gray-900/95 backdrop-blur-xl rounded-3xl shadow-xl shadow-gray-200/50 dark:shadow-gray-800/30 border border-gray-100 dark:border-gray-800 p-6">
        <div className="flex items-center mb-4">
          ...
          <div>
            <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Inspection Automation</h2>
            <p className="text-sm text-gray-600 dark:text-gray-400">Configure inspection workflow settings</p>
          </div>
        </div>

        <div className="p-4 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-xl">
          <p className="text-sm text-blue-800 dark:text-blue-300">
            These settings control the automated workflow when an inspection is marked as completed.
          </p>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div>
            ...
            <p className="mt-1 text-xs text-gray-500 dark:text-gray-400">
              Fee charged for inspection service
            </p>
          </div>
          ...
          <div>
            ...
            />
            <p className="mt-1 text-xs text-gray-500 dark:text-gray-400">
              How long estimates remain valid
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="space-y-4">
          <div className="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-800/50 rounded-xl">
            <div className="flex-1">
              <p className="font-medium text-gray-900 dark:text-white">Auto-generate Estimate</p>
              <p className="text-sm text-gray-600 dark:text-gray-400">
                Automatically create estimate from inspection items needing repair
              </p>
            </div>
          ...
          <div className="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-800/50 rounded-xl">
            <div className="flex-1">
              <p className="font-medium text-gray-900 dark:text-white">Auto-generate Invoice</p>
              <p className="text-sm text-gray-600 dark:text-gray-400">
                Automatically create invoice for inspection fee
              </p>
            </div>
            <label className="relative inline-flex items-center cursor-pointer">
              <input
          ...
          <div className="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-800/50 rounded-xl">
            <div className="flex-1">
              <p className="font-medium text-gray-900 dark:text-white">Auto-close Inspection Job Card</p>
              <p className="text-sm text-gray-600 dark:text-gray-400">
                Mark inspection job card as completed automatically
              </p>
            </div>
            <label className="relative inline-flex items-center cursor-pointer">
              <input
      ...
      <div className="bg-white/95 dark:bg-gray-900/95 backdrop-blur-xl rounded-3xl shadow-xl shadow-gray-200/50 dark:shadow-gray-800/30 border border-gray-100 dark:border-gray-800 p-6">
        ...
        <div className="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-800/50 rounded-xl">
          <div className="flex-1">
            ...
            <p className="text-sm text-gray-600 dark:text-gray-400">
              Send WhatsApp message to customer when inspection is completed
            </p>
          </div>
          <label className="relative inline-flex items-center cursor-pointer">
            <input
