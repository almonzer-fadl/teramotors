...
async function createDemoCustomer() {
  try {
    ...
    console.log('   Since email is not configured, you need to manually check the OTP.');
    console.log('   After clicking "Continue", check the server console logs.');
    console.log('   The OTP will be logged (or check the database directly).\n');
    console.log('   Alternatively, you can query the database:');
...
export default createDemoCustomer;
